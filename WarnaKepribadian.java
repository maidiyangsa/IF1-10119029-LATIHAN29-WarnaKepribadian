    ...
    // TODO code application logic here     
        ...
        String[] hijau = {
            ...
            switch (warna) {
                ...
                break;
                case "HIJAU" : warna += String.join("", biru[1], biru[0], netral[0].concat("\n"), biru[2]);
                break;
                case "KUNING" : warna += String.join("", biru[1], biru[0], netral[0].concat("\n"), biru[2]);
                break;
                case "UNGU" : warna += String.join("", biru[1], biru[0], netral[0].concat("\n"), biru[2]);
                break;
                default : warna = "Gak teridentifikasi";
            }
